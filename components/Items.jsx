              ...
              <div className="col-lg-12">
                <div className="row grid">
                  <div className="col-lg-6 currently-market-item all msc">
                    <div className="item">
                      <div className="left-image">
                        <img src="/images/market-01.jpg" alt="" style={{ borderRadius: "20px", minWidth: "195px" }} />
                      </div>
                      <div className="right-content">
                        <h4>Music Art Super Item</h4>
                        <span className="author">
                          <img src="/images/author.jpg" alt="" style={{maxWidth: "50px", borderRadius: "50%"  }} />
                  ...
                  <div className="col-lg-6 currently-market-item all vrt dig">
                    <div className="item">
                      <div className="left-image">
                        <img src="/images/market-01.jpg" alt="" style={{ bordeRadius: "20px", minWidth: "195px" }}/>
                      </div>
                      <div className="right-content">
